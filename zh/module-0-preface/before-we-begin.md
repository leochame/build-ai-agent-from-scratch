...
如果你没有任何的 LLM 基础，我建议你从 [llm-fundamentals](../module-1-llm-and-api-basics/02-llm-fundamentals/llm-fundamentals.md)看起。你必须先对 GPT 模型有一个基本的认知。
...
当你想要真正的做出一个合格的产品的时候，那这时候就需要合理的 Eval 体系，充足的相关 Benchmark 完全够 AI Agent 开发工程师去不断的优化和量化自己的产品。

...
这一模块也放入 Prompt Cache、Chat Completions Format、Function Calling / Tool Use / MCP。原因是它们还不是 Agent 的复杂系统能力，而是理解 OpenAI API、上下文成本、工具接口和对话格式的入门地基。
...
当你理解了 Chat Completions Format 和 Function Calling 之后，再看 AgentLoop：模型如何一轮一轮读取上下文、决定下一步、接收结果、更新状态，并继续推进任务。

- [AgentLoop](./module-2-agent-loop/README.md)（待写）
...
- [Dream](./module-3-context-engineering/dream.md)
...
剩下的是一些继续发展的方向，比如持续学习、Dream、Task、主动性等。
...
- [10. 我对 Agent 的思考](./module-6-future-directions/10-thoughts-on-agents/thoughts-on-agents.md)
- [AI 时代，来自程序员送给非程序员的一封情书](./module-6-future-directions/AI%20时代，来自程序员送给非程序员的一封情书.md)
...
4. [04. From Prompt To Chat Completion](./module-1-llm-and-api-basics/04-prompt-to-chat-completion/from-prompt-to-chat-completion.md)
5. [05. Function Calling / Tool Use / MCP](./module-1-llm-and-api-basics/05-function-calling/function-calling.md)
6. [AgentLoop](./module-2-agent-loop/README.md)（待写）
7. [07. Context Engineering](./module-3-context-engineering/context-engineering.md)
8. [Harness Engineering](./module-4-harness-engineering/README.md)（待写）
9. [08. Evaluation](./module-5-eval-benchmark/evaluation.md)
10. [09. Multi-Agent](./module-6-future-directions/09-multi-agent/multi-agent.md)
